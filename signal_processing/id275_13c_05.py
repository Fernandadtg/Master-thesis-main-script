...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  3 11:09:37 2022
...
path='/home/u/pyNMR/29 abril/nmr_bruker/id275_13c_05'
info_path = glob.glob(os.path.join(path + str('/202204*')))[0] #info_path
print(info_path)

file_title = path.split('/home/u/pyNMR/29 abril/nmr_bruker/', maxsplit=1)[1]
print("file_title")
print(file_title)
...
with open("integ_id273_13c_05.txt", "w") as output:
